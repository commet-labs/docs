...
### Authentication
- [`commet login`](/library/cli/commands#login) - Authenticate with Commet
- [`commet logout`](/library/cli/commands#logout) - Remove credentials
- [`commet whoami`](/library/cli/commands#whoami) - Display auth status

### Project Management
- [`commet link`](/library/cli/commands#link) - Link project to organization
- [`commet unlink`](/library/cli/commands#unlink) - Unlink project
- [`commet switch`](/library/cli/commands#switch) - Switch organization
- [`commet info`](/library/cli/commands#info) - Show project details

### Type Generation
- [`commet pull`](/library/cli/commands#pull) - Generate TypeScript types
- [`commet list`](/library/cli/commands#list) - List event/seat types
...
See [Installation Guide](/library/cli/installation) for detailed setup instructions.
...
See [Configuration](/library/cli/configuration) for details.