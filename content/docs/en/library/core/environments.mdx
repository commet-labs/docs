...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
  <div className="border rounded-lg p-4">
    <h3 className="font-semibold mt-0">Authentication</h3>
    <p className="text-sm text-muted-foreground">Configure API keys and validation</p>
    <p className="text-sm">[Authentication →](/library/core/authentication)</p>
  </div>
