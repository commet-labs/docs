...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
  <div className="border rounded-lg p-4">
    <h3 className="font-semibold mt-0">Customer Management</h3>
    <p className="text-sm text-muted-foreground">Apply pagination to customer lists</p>
    <p className="text-sm">[Manage customers →](/library/features/customers)</p>
  </div>
  
  <div className="border rounded-lg p-4">
    <h3 className="font-semibold mt-0">Usage Events</h3>
    <p className="text-sm text-muted-foreground">Paginate through event history</p>
