...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
  <div className="border rounded-lg p-4">
    ...
    <p className="text-sm text-muted-foreground">Manage sandbox and production environments</p>
    <p className="text-sm">[Learn environments →](/library/core/environments)</p>
  </div>
