...
- **Clear approvals**: large discounts route through the right approval path automatically.
- **Analytics that make sense**: track list price vs. customer price to measure discount adoption.
...
2. Browse your product catalog to see all available SKUs
...
1. Start with an existing list price
2. Click **Create Variant** to customize for a specific customer or segment
3. Apply adjustments:
   - Discounts or markups
   - Modified unit amounts
   - Custom included units
   - Different currency
4. Link to a customer (optional) or use for segment-based pricing

### Use prices in quotes and billing

**For customer quotes:**
1. Select a list price as your starting point
2. Apply any necessary adjustments via price variant
3. Generate the quote with transparent pricing breakdown

**For billing schedules:**
1. Reference list prices or price variants in agreements
2. The billing engine automatically calculates based on the pricing cascade
3. Invoices show clear line items with pricing origin
